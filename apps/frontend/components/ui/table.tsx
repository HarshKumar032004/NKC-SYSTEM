...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("bg-slate-50/80 border-b border-slate-200 [&_tr]:border-b-0", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      // Border + hover + selected state
      "border-b border-slate-100 transition-colors duration-100",
      "hover:bg-slate-50/70",
      "data-[state=selected]:bg-indigo-50/60 data-[state=selected]:border-indigo-100",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    scope="col"    /* WCAG: identifies this as a column header */
    className={cn(
